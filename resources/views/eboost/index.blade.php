    ...
    <div class="container">
        ...
        <div class="card border-light my-4">
            <div class="row g-0">
                ...
                <div class="col-lg-8">
                    <div class="card-body">
                        <h2 class="card-title">{{$eboost->judul_tentang}}</h2>
                        <div style="height: 2px; background-color:#000000"></div>
                        <p class="card-text align-middle" style="font-size: 20px">{{$eboost->caption_tentang}} </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-8">
                    <div class="card-body">
                        ...
                        <div style="height: 2px; background-color:#000000"></div>
                        <p class="card-text align-middle" style="font-size: 20px">{{$eboost->caption_info}}</p>
                    </div>
                </div>
            </div>
        </div>
