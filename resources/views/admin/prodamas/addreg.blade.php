...
<form action="/admin/storereg-prodamas" method="POST" enctype="multipart/form-data">
    @csrf

    <div class="form-group">
        <label for="judul">Judul</label>
        <textarea name="judul" class="form-control" id="description" name=" judul" placeholder="Judul"></textarea>
        @error('judul')
    ...
    <div class="form-group">
        ...
        <input name="sumber" class="form-control" name="sumber" placeholder="Sumber">
        @error('sumber')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
