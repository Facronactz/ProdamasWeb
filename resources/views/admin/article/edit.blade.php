...
<form action="/admin/article/{{ $article->id }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="text_sampul" id="text_sampul" placeholder="text_sampul of article"
            value="{{ $article->text_sampul }}">
        @error('text_sampul')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="judul" id="judul" placeholder="judul of article"
            value="{{ $article->judul }}">
        @error('judul')
        <div class="alert alert-danger">
            {{ $message }}
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="slug" id="slug" placeholder="slug of article"
            value="{{ $article->slug }}">
        @error('slug')
        <div class="alert alert-danger">
            {{ $message }}
    ...
    <div class="form-group">
        ...
        <textarea name="article" id="description" class="form-control" cols="30"
            rows="10">{{ $article->article }}</textarea>
        @error('article')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
