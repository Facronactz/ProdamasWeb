...
<form action="/admin/storelist-kube" method="POST" enctype="multipart/form-data">
    @csrf

    <div class="form-group">
        <label for="judul">Nama Kube</label>
        <input name="judul" class="form-control" name="judul" id="judul" placeholder="Nama Kube">
        @error('judul')
