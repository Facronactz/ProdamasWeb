...
<form action="/admin/list-eboost" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea name="caption_tentang" class="form-control" name="caption_tentang" id="caption_tentang" placeholder="caption_tentang">
    ...
    <div class="form-group">
        ...
        <textarea name="caption_info" class="form-control" name="caption_info" id="caption_info" placeholder="caption_info">
        @error('caption_info')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
