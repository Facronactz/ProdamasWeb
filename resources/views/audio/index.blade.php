                ...
                <div class="modal-body">
                    <div class="row row-cols-1 row-cols-md-3 mb-2 g-4 audioPlayerBox centerItms">
                        <div class="card" style="
                                ...
                                <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1245020674&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/prodamas-pemerintah-kota-kediri" title="PRODAMAS KOTA KEDIRI" target="_blank" style="color: #cccccc; text-decoration: none;">PRODAMAS KOTA KEDIRI</a> · <a href="https://soundcloud.com/prodamas-pemerintah-kota-kediri/jingle-prodamas" title="Jingle - Prodamas" target="_blank" style="color: #cccccc; text-decoration: none;">Jingle - Prodamas</a></div>
