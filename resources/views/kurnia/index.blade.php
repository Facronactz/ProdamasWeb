...
<div class="container">
    ...
    <div class="card border-light my-4">
        <div class="row g-0">
            ...
            <div class="col-lg-4 d-flex justify-content-center">
                <img src="{{ asset('kurniaProd/'.$e->foto_alur) }}" class="img-fluid" style="max-height: 400px;">
            </div>
            <div class="col-lg-8">
                <div class="card-body">
                    <h2 class="card-title">{{ $e->judul_alur }}</h2>
                    <div style="height: 2px; background-color:#000000"></div>
                    <p class="card-text align-middle" style="font-size: 20px"><?= $e->caption_alur ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-light my-4">
        <div class="row g-0">
            <div class="col-lg-4 d-flex justify-content-center">
                <img src="{{ asset('kurniaProd/'.$e->foto_info) }}" class="img-fluid" style="max-height: 400px;">
            </div>
            <div class="col-lg-8">
                <div class="card-body">
