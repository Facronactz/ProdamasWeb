...
<body data-bs-spy="scroll" data-bs-target="#scrollspy" data-bs-offset="0" data-bs-method="position">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarNavAltMarkup">
                        ...
                        <div class="navbar-nav">
                            ...
                            <div class="nav-item dropdown nav-list">
                                ...
                                <li class="dropdown-submenu w-100">
                                    <a class="dropdown-item @yield('e-boost')" href="{{ url('/permodalan') }}">Akses Permodalan <span class="caret fas fa-caret-right ms-3"></span></a>
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu w-100">
    ...
    $(document).ready(function(){
      $('.multiple-items').slick({
          ...
          slidesToShow: 3,
          slidesToScroll: 3,
          nextArrow: $($.parseHTML('<button type="button" class="slick-prev carousel-icon-next">Next</button>')); 
      });
    });
    </script>
