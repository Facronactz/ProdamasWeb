    ...
    <footer>
        <div class="footer-top" id="footer">
            ...
            <div class="col-md-5 col-lg-4 offset-lg-2 footer-contact" style="margin-top: 45px; margin-left: 0px; color: white; font-family: 'Poppins', sans-serif;">
                ...
                <p style="font-weight: 400; font-size: 11px"><i class="fas fa-envelope foot-icon"></i> (0354) 682955</p>
                <p style="font-weight: 400; font-size: 11px"><i class="fas fa-phone foot-icon ph"></i> prodamas@kedirikota.go.id</p>
            </div>
