                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarNavAltMarkup">
                        ...
                        <div class="navbar-nav">
                            ...
                            <div class="nav-item dropdown nav-list">
                                ...
                                <a role="button" style="width: 5px; height: 5px; margin-right: -1rem" class="nav-link nav-list dropdown-toggle dropdown-toggle-split" id="dropdownMenuEboost" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
