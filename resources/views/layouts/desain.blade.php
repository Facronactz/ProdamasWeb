                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarNavAltMarkup">
                        ...
                        <div class="navbar-nav">
                            ...
                            <div class="nav-item dropdown nav-list">
                                ...
                                <a role="button" style="margin-bottom: 20px; left: 70px;" class="nav-link nav-list dropdown-toggle dropdown-toggle-split" id="dropdownMenuEboost" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
