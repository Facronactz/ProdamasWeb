...
<body data-bs-spy="scroll" data-bs-target="#scrollspy" data-bs-offset="0" data-bs-method="position">
    ...
    <div class="nav-now" style="background-color: #4d148c">
        <a href=" {{ url('/') }}"><img src="{{asset('img/wesite logo 1.png')}}" alt="" class="d-inline-block align-text-top" style="width: 200px; height: auto; padding: 2rem 2rem; margin-bottom: -2rem" /></a>
        <div class="bg-iki">
