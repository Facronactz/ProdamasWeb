            ...
            <div class="col">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8  mt-4">
                            <div class="card-body isi">
                                <h4 style="font-family: Inter, sans-serif; text-decoration-line: underline; text-decoration-style: double;" class="card-title">Sejarah Prodamas</h4>
                ...
                <div class="mb-3 kartukanan">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body isi">
                                <h4 style="font-family: Inter, sans-serif; text-decoration-line: underline; text-decoration-style: double;" class="card-title">Transformasi Prodamas menjadi Prodamas Plus</h4>
                ...
                <div class="text-center mt-3">
                    <img src="/img-tentang/Transformasi Prodamas-Prodamas Plus.jpg" class="rounded" style="width: 100%;" alt="Gambar Transformasi Prodamas-Prodamas Plus">
                </div>
...
>>>>>>> 92e19b212366f3edbccc276867b6991fbc20d052
                </div>
            </div>
        </div>
        <!--tag akhir-->
