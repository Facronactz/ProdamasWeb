...
class SearchController extends Controller
{
        public function search(Request $request)
        {
                ...
                $videos = VideoAdmin::where('judul', 'like', "%" . $keyword . "%")
                        ...
                        // ->get()
                ;
                return view('search.search', compact('audios', 'artikel', 'images', 'posts', 'videos', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchartikel(Request $request)
        {
                ...
                return view('artikel.artikelsearch', compact('artikel', 'totalviews', 'counter', 'menus'));
        }
        ...
        public function searchtagartikel()
        {
                ...
                return view('artikel.artikeltagsearch', compact('artikel', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchaudio(Request $request)
        {
                ...
                return view('audio.audiosearch', compact('audios', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchtagaudio()
        {
                ...
                return view('audio.audiotagsearch', compact('audios', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchfoto(Request $request)
        {
                ...
                return view('foto.fotosearch', compact('fotos', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchtagfoto()
        {
                ...
                return view('foto.fototagsearch', compact('fotos', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchvideo(Request $request)
        {
                ...
                return view('video.videosearch', compact('videos', 'totalviews','counter', 'menus'));
        }
        ...
        public function searchcerita(Request $request)
        {
                ...
                $tulis_ceritas = CeritaAdmin::where('judul', 'like', "%" . $keyword . "%")
                        ...
                        ->paginate(2);
                return view('cerita.searchcerita', compact('tulis_ceritas', 'totalviews', 'counter', 'menus'))->with('i', (request()->input('page', 1) - 1) * 5);
        }
        ...
        public function searchtagcerita()
        {
                ...
                return view('cerita.ceritatagsearch', compact('tulis_ceritas', 'totalviews','counters', 'menus'));
        }
